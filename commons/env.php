...
define('BASE_URL', 'http://localhost/CODE/du_an_1/Git_du_an_3/du_an_1/');
define('BASE_URL_ADMIN', 'http://localhost/CODE/du_an_1/Git_du_an_3/du_an_1/admin/');

define('DB_HOST', 'localhost');
define('DB_PORT', '3306');
define('DB_NAME', 'duan04');
define('DB_PASSWORD', '');
