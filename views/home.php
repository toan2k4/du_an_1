    ...
    <div class="row row-10 mbn-20">
        ...
        <div class="col-lg-4 col-md-6 col-12 mb-20">
            <div class="banner banner-1 content-left content-middle">
                ...
                <a href="#" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/banner/banner-1.jpg" alt="Banner Image"></a>
        ...
        <div class="col-lg-4 col-md-6 col-12 mb-20">
            <div class="banner banner-1 content-left content-top">
                ...
                <a href="#" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/banner/banner-3.jpg" alt="Banner Image"></a>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
            ...
            <div class="product-item">
                <div class="product-inner">
                    ...
                    <div class="image">
                        <img src="<?= BASE_URL ?>/assets/user/assets/images/product/product-1.jpg" alt="Image">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
            ...
            <div class="product-item">
                <div class="product-inner">
                    ...
                    <div class="image">
                        <img src="<?= BASE_URL ?>/assets/user/assets/images/product/product-2.jpg" alt="Image">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
            ...
            <div class="product-item">
                <div class="product-inner">
                    ...
                    <div class="image">
                        <img src="<?= BASE_URL ?>/assets/user/assets/images/product/product-3.jpg" alt="Image">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
            ...
            <div class="product-item">
                <div class="product-inner">
                    ...
                    <div class="image">
                        <img src="<?= BASE_URL ?>/assets/user/assets/images/product/product-4.jpg" alt="Image">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
            ...
            <div class="product-item">
                <div class="product-inner">
                    ...
                    <div class="image">
                        <img src="<?= BASE_URL ?>/assets/user/assets/images/product/product-5.jpg" alt="Image">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
            ...
            <div class="product-item">
                <div class="product-inner">
                    ...
                    <div class="image">
                        <img src="<?= BASE_URL ?>/assets/user/assets/images/product/product-6.jpg" alt="Image">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
            ...
            <div class="product-item">
                <div class="product-inner">
                    ...
                    <div class="image">
                        <img src="<?= BASE_URL ?>/assets/user/assets/images/product/product-7.jpg" alt="Image">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-40">
            ...
            <div class="product-item">
                <div class="product-inner">
                    ...
                    <div class="image">
                        <img src="<?= BASE_URL ?>/assets/user/assets/images/product/product-8.jpg" alt="Image">
...
<div class="row row-5 mbn-10">
    ...
    <div class="col-lg-4 col-md-6 col-12 mb-10">
        <div class="banner banner-3">
            ...
            <a href="#" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/banner/banner-4.jpg" alt="Banner Image"></a>

            <div class="content" style="background-image: url(<?= BASE_URL ?>/assets/user/assets/images/banner/banner-3-shape.png)">
                <h1>New Arrivals</h1>
                <h2>Up to 35% off</h2>
                <h4>2 - 5 Years</h4>
            </div>
    ...
    <div class="col-lg-4 col-md-6 col-12 mb-10">
        <div class="banner banner-4">
            ...
            <a href="#" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/banner/banner-5.jpg" alt="Banner Image"></a>
    ...
    <div class="col-lg-4 col-md-6 col-12 mb-10">
        <div class="banner banner-5">
            ...
            <a href="#" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/banner/banner-6.jpg" alt="Banner Image"></a>

            <div class="content" style="background-image: url(<?= BASE_URL ?>/assets/user/assets/images/banner/banner-5-shape.png)">
            ...
            <div class="best-deal-slider w-100">
                ...
                <div class="slide-item">
                    <div class="best-deal-product">
                        ...
                        <div class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/best-deal-1.jpg" alt="Image"></div>
                ...
                <div class="slide-item">
                    <div class="best-deal-product">
                        ...
                        <div class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/best-deal-2.jpg" alt="Image"></div>
            ...
            <div class="small-product-slider row row-7 mbn-40">
                ...
                <div class="col mb-40">
                    ...
                    <div class="on-sale-product">
                        <a href="single-product.html" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/on-sale-1.jpg" alt="Image"></a>
                ...
                <div class="col mb-40">
                    ...
                    <div class="on-sale-product">
                        <a href="single-product.html" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/on-sale-2.jpg" alt="Image"></a>
                        <div class="content text-center">
                ...
                <div class="col mb-40">
                    ...
                    <div class="on-sale-product">
                        <a href="single-product.html" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/on-sale-3.jpg" alt="Image"></a>
                        <div class="content text-center">
                ...
                <div class="col mb-40">
                    ...
                    <div class="on-sale-product">
                        <a href="single-product.html" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/on-sale-4.jpg" alt="Image"></a>
                        <div class="content text-center">
                ...
                <div class="col mb-40">
                    ...
                    <div class="on-sale-product">
                        <a href="single-product.html" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/on-sale-5.jpg" alt="Image"></a>
                        <div class="content text-center">
                ...
                <div class="col mb-40">
                    ...
                    <div class="on-sale-product">
                        <a href="single-product.html" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/on-sale-6.jpg" alt="Image"></a>
                        <div class="content text-center">
                ...
                <div class="col mb-40">
                    ...
                    <div class="on-sale-product">
                        <a href="single-product.html" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/on-sale-7.jpg" alt="Image"></a>
                        <div class="content text-center">
                ...
                <div class="col mb-40">
                    ...
                    <div class="on-sale-product">
                        <a href="single-product.html" class="image"><img src="<?= BASE_URL ?>/assets/user/assets/images/product/on-sale-8.jpg" alt="Image"></a>
                        <div class="content text-center">
                            <h4 class="title"><a href="single-product.html">Tmart Baby Dress</a></h4>
...
<div class="feature-section bg-theme-two section section-padding fix" style="background-image: url(<?= BASE_URL ?>/assets/user/assets/images/pattern/pattern-dot.png);">
<div class="container">
    <div class="feature-wrap row justify-content-between mbn-30">
        ...
        <div class="col-md-4 col-12 mb-30">
            <div class="feature-item text-center">
                ...
                <div class="icon"><img src="<?= BASE_URL ?>/assets/user/assets/images/feature/feature-1.png" alt="Image"></div>
                <div class="content">
                    <h3>Free Shipping</h3>
                    <p>Start from $100</p>
                </div>
        ...
        <div class="col-md-4 col-12 mb-30">
            <div class="feature-item text-center">
                ...
                <div class="icon"><img src="<?= BASE_URL ?>/assets/user/assets/images/feature/feature-2.png" alt="Image"></div>
                <div class="content">
        ...
        <div class="col-md-4 col-12 mb-30">
            <div class="feature-item text-center">
                ...
                <div class="icon"><img src="<?= BASE_URL ?>/assets/user/assets/images/feature/feature-3.png" alt="Image"></div>
                <div class="content">
            ...
            <div class="row mbn-40">
                ...
                <div class="col-12 mb-40">
                    <div class="testimonial-item">
                        ...
                        <div class="testimonial-author">
                            <img src="<?= BASE_URL ?>/assets/user/assets/images/testimonial/testimonial-1.png" alt="Image">
                            <div class="content">
                ...
                <div class="col-12 mb-40">
                    <div class="testimonial-item">
                        <p>Jadusona is one of the most exclusive Baby shop in the wold, where you can find all product for your baby that your want to buy for your baby. I recomanded this shop all of you</p>
                        <div class="testimonial-author">
                            <img src="<?= BASE_URL ?>/assets/user/assets/images/testimonial/testimonial-2.png" alt="Image">
                            <div class="content">
                ...
                <div class="col-12 mb-40">
                    <div class="blog-item">
                        <div class="image-wrap">
                            ...
                            <a class="image" href="single-blog.html"><img src="<?= BASE_URL ?>/assets/user/assets/images/blog/blog-1.jpg" alt="Image"></a>
                        </div>
                        <div class="content">
                            ...
                            <ul class="meta">
                                <li><a href="#"><img src="<?= BASE_URL ?>/assets/user/assets/images/blog/blog-author-1.jpg" alt="Blog Author">Muhin</a></li>
                ...
                <div class="col-12 mb-40">
                    <div class="blog-item">
                        <div class="image-wrap">
                            ...
                            <a class="image" href="single-blog.html"><img src="<?= BASE_URL ?>/assets/user/assets/images/blog/blog-2.jpg" alt="Image"></a>
                        </div>
                        <div class="content">
                            ...
                            <ul class="meta">
                                <li><a href="#"><img src="<?= BASE_URL ?>/assets/user/assets/images/blog/blog-author-2.jpg" alt="Blog Author">Takiya</a></li>
                                <li><a href="#">25 Likes</a></li>
                                <li><a href="#">05 Views</a></li>
                            </ul>
                        </div>
