                                ...
                                <div class="container mb-5 mt-3">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-xl-7">
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li class="fs-6 mb-2">Tên người nhận : <span style="color:#8f8062 ;"><?= $order_detail['ho_va_ten'] ?></span></li>
                                                    <li class="fs-6 mb-2">Địa chỉ : <?= $order_detail['dia_chi'] ?></li>
                                                    <li class="fs-6 mb-2"><i class="bi bi-telephone text-warning"></i></i> <?= $order_detail['dien_thoai_tk'] ?></li>
                                                </ul>
                                            </div>
                                            <div class="col-xl-5">
                                                <p class="fs-6 mb-2 fw-bolder text-black ">Hóa đơn</p>
                                                <ul class="list-unstyled">
                                                    <li class="fs-6 mb-2"><i class="bi bi-dot"></i> <span>Ngày đặt hàng : </span><?= date('d-m-Y', strtotime($order_detail['thoi_gian'])) ?></li>
                                                    <li class="fs-6 mb-2"><i class="bi bi-dot"></i> <span>Hình thức thanh toán : </span><?php
                                                    ...
                                                    <li class="fs-6 mb-2"><i class="bi bi-dot"></i><span>Trạng thái : </span>
                                        ...
                                        <?php foreach ($order_product as $key => $value): ?>
                                            <div class="row my-2 mx-1 justify-content-center d-flex " style="align-items: center;">
                                                <div class="col-md-2 mb-4 mb-md-0 mt-3">
                                                    <div class="rounded-5 mb-4 overflow-hidden " data-ripple-color="light">
                                                        <img src="<?= BASE_URL . $value['hinh_sp'] ?>" class="w-120" height="150px" alt="anh san pham" />
                                                    </div>
                                                </div>
                                                <div class="col-md-7 mb-4 mb-md-0 mt-3">
                                                    <p class="fw-bold fs-6"><?= $value['ten_sp'] ?></p>
                                                    <p class="mb-1">
                                                        <span class="text-muted me-2">Kích thước :</span><span><?= $value['size'] ?></span>
                                                    </p>
                                                    <p>
                                                        <span class="text-muted me-2 ">Màu :</span><button style="background-color: black;"></button>
                                                    </p>
                                                    <p>
                                                        <span class="text-muted me-2">Số lượng :</span><span><?= $value['so_luong'] ?></span>
                                                    </p>
                                                </div>
                                                <div class="col-md-3 mb-4 mb-md-0 mt-3">
                                                    <h5 class="mb-2">
                                                        <span class="fw-bold fs-5"><?= number_format($value['thanh_tien'], 0, ',') ?> đ</span>
                                                    </h5>
                                                </div>
                                            </div>
                                        <?php 
