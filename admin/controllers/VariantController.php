...
{
    $title = 'Form thêm biến thể sản phẩm';
    $view = 'variants/index';
    ...
    if (!empty ($_POST)) {
        ...
        $idNewVariant = insert_get_last_id('tb_bien_the_sp', $data);
        $_SESSION['success'] = "Thao tác thành công";
        if (!empty ($idNewVariant)) {
            $variants = listAllVariantByIdsp($idNewVariant);
...
function variantListAll($id)
{
    ...
    $_SESSION['variants'] = $variants;
    require_once PATH_VIEW_ADMIN . 'variants/show.php';
}
